...
export const Hartford = (props) => {
  return (
    <main className="relative min-h-screen w-screen overflow-x-hidden">
      <title>Hair Braiding in Hartford CT | Austin Mobile Hair Braiding: Mobile Hair Braiding Hartford | Austin Mobile Hair Braiding CT</title>
      <meta
        name="description"
        content="Austin Mobile Hair Braiding CT: Your premier mobile hair braiding salon in Hartford, CT. Specializing in box braids, knotless braids, Senegalese twists, and more. Expert African hair braiding services brought directly to you in Hartford. Book your appointment today for top-rated braids in Hartford!"
      />
      <meta
        name="keywords"
      ...
      <header id="header">
        <div className="relative">
          ...
          <div className="relative z-20 py-20 md:py-32 lg:py-40 xl:py-48 px-6 md:px-10 lg:px-20 xl:px-32 text-center text-white">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-1xl md:text-3xl mb-8 font-semibold">
                Austin Mobile Hair Braiding brings expert African hair braiding directly to you in Hartford, CT!
              </p>
          ...
          <link rel="canonical" href="https://www.atxmobilebraiding.com/hartford" />
      <Smallergallery />
      <Contact />
    </main>
  );
