...
export const Newport = (props) => {
  return (
    <main className="relative min-h-screen w-screen overflow-x-hidden">
      <title>Hair Braiding in Newport RI | Austin Mobile Hair Braiding: Mobile Hair Braiding Newport | Austin Mobile Hair Braiding RI</title>
      <meta
        name="description"
        content="Austin Mobile Hair Braiding RI: Your premier mobile hair braiding salon in Newport, RI. Specializing in box braids, knotless braids, Senegalese twists, and more. Expert African hair braiding services brought directly to you in Newport. Book your appointment today for top-rated braids in Newport!"
      />
      <meta
        name="keywords"
          ...
          <div className="relative z-20 py-20 md:py-32 lg:py-40 xl:py-48 px-6 md:px-10 lg:px-20 xl:px-32 text-center text-white">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-1xl md:text-3xl mb-8 font-semibold">
                Austin Mobile Hair Braiding brings expert African hair braiding directly to you in Newport, RI!
              </p>
              <p className="text-base md:text-lg mb-8 text-gray-200 hidden">
                ...
                <link rel="canonical" href="https://www.atxmobilebraiding.com/newport" />
            <div className="mt-10">
              <a
                href="https://app.squareup.com/appointments/book/9sa73pd3r58ged/LX4S95WG88DY2/start"
