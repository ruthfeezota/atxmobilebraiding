...
export const Springfield = (props) => {
  return (
    <main className="relative min-h-screen w-screen overflow-x-hidden">
      <title>Hair Braiding in Springfield MA | Austin Mobile Hair Braiding: Mobile Hair Braiding Springfield | Austin Mobile Hair Braiding MA</title>
      <meta
        name="description"
        content="Austin Mobile Hair Braiding MA: Your premier mobile hair braiding salon in Springfield, MA. Specializing in box braids, knotless braids, Senegalese twists, and more. Expert African hair braiding services brought directly to you in Springfield. Book your appointment today for top-rated braids in Springfield!"
      />
      <meta
        name="keywords"
          ...
          <div className="relative z-20 py-20 md:py-32 lg:py-40 xl:py-48 px-6 md:px-10 lg:px-20 xl:px-32 text-center text-white">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-1xl md:text-3xl mb-8 font-semibold">
                Austin Mobile Hair Braiding brings expert African hair braiding directly to you in Springfield, MA!
              </p>
    ...
    <link rel="canonical" href="https://www.atxmobilebraiding.com/springfield" />
      <Smallergallery />
